...
import {
    lessonProgramContent,
    lessonProgramHeaders,
        ...
        swalQuestion(
            ...
            if (response.isConfirmed) {
                try {
                    ...
                    swalToast("Lesson program deleted successfully", "success");
        ...
        <div className="d-flex flex-column w-100 gap-4">
            ...
            <div className="d-flex justify-content-end">
                <Button
                    onClick={() =>
                        navigate(
                            "/dashboard/lesson-management/new-lesson-program"
                        )
                    }
                    variant="secondary"
                    className="fw-bold text-light btn-wide">
                    Create New Lesson Program
                </Button>
            </div>
            <div
                ...
                style={{ maxWidth: "100%" }}>
                <CustomTable
                    content={lessonProgramContent}
                    currentPage={currentPage}
                    data={data?.content}
                    handleDelete={handleDelete}
                    headers={lessonProgramHeaders}
                    id="lessonProgramId"
                    isDelete={true}
                    loading={loading}
                    pageSize={pageSize}
...
export default LessonProgramsPage;
